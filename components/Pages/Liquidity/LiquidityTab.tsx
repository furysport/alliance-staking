...
export const LiquidityTab = ({
  ...
  const openDelegate = async () => await router.push('/liquidity/delegate?tokenSymbol=USDC-FURY-LP')
  const openUndelegate = async () => await router.push('/liquidity/undelegate?tokenSymbol=USDC-FURY-LP')
