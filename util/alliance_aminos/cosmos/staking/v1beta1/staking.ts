...
export const Cosmos_cryptoPubKey_FromAmino = (content: AnyAmino): Any => encodePubkey(content);
export const Cosmos_cryptoPubKey_ToAmino = (content: Any): Pubkey | null => decodePubkey(content);
