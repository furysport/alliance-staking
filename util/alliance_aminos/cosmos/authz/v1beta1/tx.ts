...
export const Cosmos_basev1beta1Msg_FromAmino = (content: AnyAmino): Any => Any.fromAmino(content);
export const Cosmos_basev1beta1Msg_ToAmino = (content: Any) => Any.toAmino(content);
