...
export const Cosmwasm_wasmv1ContractInfoExtension_FromAmino = (content: AnyAmino): Any => Any.fromAmino(content);
export const Cosmwasm_wasmv1ContractInfoExtension_ToAmino = (content: Any) => Any.toAmino(content);
